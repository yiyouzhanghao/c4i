...
function snsearchclick(){
    ...
    if(sninputvalue){
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/snserachlist',{
            params: {
              sn:sninputvalue 
            }
          }
